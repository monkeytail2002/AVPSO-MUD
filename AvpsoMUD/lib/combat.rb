...
class Combat
  ...
  def fight
    ...
    mob_ac = mob_sheet["B1"].to_i  #grabs the value from the spreadsheet as an integer
    ...
    #This if statement is apparently broken.  For some reason the comparison operators aren't working correctly.
    ...
    #Thanks to the briken if statement, it will return the damaged HP even if to hit is lower than AC
  end
end
